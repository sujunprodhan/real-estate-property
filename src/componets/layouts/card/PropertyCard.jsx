      ...
      <div className="relative h-72 w-full overflow-hidden">
        ...
        <div className="absolute top-5 left-5 right-5 z-20 flex justify-between items-start">
          <div className="flex flex-col gap-2">
            <span
              className={`text-[11px] font-black uppercase tracking-wider px-4 py-2 rounded-full shadow-lg backdrop-blur-md ${property.status === 'For Rent' ? 'bg-secondary/90 text-secondary-content' : 'bg-primary/90 text-primary-content'}`}
            >
              {property.status}
            </span>
          </div>
        ...
        <div className="absolute bottom-4 left-5 right-5 z-20 flex items-center gap-2">
          <MapPin
            size={18}
            className="text-white group-hover:text-primary transition-colors duration-300 shrink-0 drop-shadow-lg"
          />
          <span className="text-white/95 text-[15px] font-bold truncate drop-shadow-lg tracking-wide">
            {property.location?.address}, {property.location?.city}
          </span>
        </div>

        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-60 pointer-events-none z-10"></div>
      </div>
      ...
      <div className="p-7 flex flex-col flex-grow bg-base-100 relative">
        ...
        <div className="text-3xl font-black text-primary mb-6 flex items-end gap-1">
          ...
          {property.status === 'For Rent' && (
            <span className="text-base text-base-content/50 font-semibold mb-1">/mo</span>
          )}
        </div>
        ...
        <div className="grid grid-cols-3 gap-2 bg-base-200/50 rounded-2xl p-4 mb-6 border border-base-200/50">
          <div className="flex flex-col items-center justify-center gap-1.5">
            <BedDouble
              size={22}
              className="text-base-content/60 group-hover:text-primary transition-colors duration-300 mb-0.5"
            />
            <span className="text-base-content font-bold text-[15px]">{property.bedrooms}</span>
            <span className="text-base-content/50 text-[10px] uppercase tracking-wider font-bold">
              Beds
            </span>
          </div>
          ...
          <div className="flex flex-col items-center justify-center gap-1.5 border-x border-base-300">
            <Bath
              ...
              className="text-base-content/60 group-hover:text-primary transition-colors duration-300 mb-0.5"
            />
            <span className="text-base-content font-bold text-[15px]">{property.bathrooms}</span>
            <span className="text-base-content/50 text-[10px] uppercase tracking-wider font-bold">
              Baths
            </span>
          </div>
          ...
          <div className="flex flex-col items-center justify-center gap-1.5">
            <Square
              ...
              className="text-base-content/60 group-hover:text-primary transition-colors duration-300 mb-0.5"
            />
            <span className="text-base-content font-bold text-[15px]">{property.area}</span>
            <span className="text-base-content/50 text-[10px] uppercase tracking-wider font-bold">
              Sqft
            </span>
          </div>
        ...
        <div className="mt-auto flex items-center justify-between pt-5 border-t border-base-200">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-[10px] uppercase tracking-widest text-base-content/50 font-bold mb-0.5">
                Agent
              </span>
              <span className="text-[15px] font-extrabold text-base-content">
          ...
          <Link
            ...
            className="btn btn-primary rounded-full px-7 hover:scale-105 hover:shadow-xl hover:shadow-primary/30 transition-all font-bold text-white border-none"
          >
            Details
          </Link>
        </div>
